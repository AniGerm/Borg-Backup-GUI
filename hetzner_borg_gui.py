#!/usr/bin/env python3
"""
Hetzner Borg Backup GUI - Komplettes Backup-Management mit Borg und Hetzner Storage Box.
...
# KONFIGURATION
# ============================================================
CONFIG_DIR = Path.home() / '.config' / 'hetzner-borg-gui'
...
# HAUPT-GUI-KLASSE
# ============================================================
class HetznerBorgGUI:
    def __init__(self, master):
        self.master = master
        try:
            master.tk.call('tk', 'appname', 'HetznerBorgGUI')
        except Exception:
            pass
        try:
            master.wm_class('HetznerBorgGUI')
        except Exception:
            pass
        master.title('Hetzner Borg GUI')
    ...
    def _build_backup_tab(self):
        ...
        server_frame = ttk.LabelFrame(left, text='Server-Konfiguration (Hetzner)')
    ...
    def _borg_env(self):
        ...
        # ssh_cmd: Host Keys beim ersten Mal automatisch akzeptieren. Hetzner Storage Box verlangt Port 23 für Borg!
        ssh_cmd = ("ssh -p 23"
    ...
    def _start_tray_icon(self):
        ...
        try:
            self.tray_icon = pystray.Icon('hetzner_borg_gui', image, 'Hetzner Borg GUI', self._build_pystray_menu())
    ...
    def _tray_live_summary_lines(self):
        ...
        status_title = self.status_title_var.get() if hasattr(self, 'status_title_var') else 'Hetzner Borg GUI'
    ...
    def _start_native_indicator(self):
        ...
        try:
            ...
            if GLib is not None:
                ...
                title = self.status_title_var.get() if hasattr(self, 'status_title_var') else 'Hetzner Borg GUI'
